...
| NCP opt-in | Default runtime remains independent; NCP feature compiles/tests; command validation/TTL/final-HOLD tests pass | Registering/invoking dormant paths accidentally or claiming a live loop without explicit integration evidence |

...
| Separate typed city application or city reader | `bun run validate:with-ncp-city` with the same explicit dependency; read the [city contract](integrations/ncp-force-city-sources/README.md) |

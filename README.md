...
The [owned Python session](integrations/ncp-force-ground-sensors/python/README.md#install-and-run-a-body-session) provides explicit runtime installation, process startup, and bounded retirement.

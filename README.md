...
| **Plant Authority** | Dependency-free headless lifecycle/channel/passive-expiry foundation; inert self-check only, with no command ingress, active watchdog, or FCU adapter | L0 Foundation |
